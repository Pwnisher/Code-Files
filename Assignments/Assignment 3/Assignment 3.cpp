...
{
	char ifStatementMainMenuChoice;
...
{
	//clrscr();
	char Array1DMMChoice;
	while (Array1DMMChoice != 'E')//(arrayMainMenuChoice == 'A' || 'B' || 'C' || 'D')
	{
		//clrscr();
		//gotoxy(29,1);
...
void mainMenu()
{
	...
	while (mainMenuChoice != 'E')  //== 'A' || 'B' || 'C' || 'D' || 'E')
	{
		...
		//gotoxy(1,8);
		cout << "D. 1D Array Main Menu" << endl;
		//gotoxy(1,9);
		cout << "E. Exit" << endl;
		//gotoxy(1,11);
		cout << "Choice: ";
